...
static_assert(std::is_standard_layout<PluginImplDesc>::value, "Invalid assumption");
...
static_assert(std::is_standard_layout<PluginRegistryEntry>::value, "Invalid assumption");
static_assert(std::is_standard_layout<PluginRegistryEntry::Interface>::value, "Invalid assumption");
...
static_assert(std::is_standard_layout<PluginRegistryEntry2>::value, "Invalid assumption");
static_assert(std::is_standard_layout<PluginRegistryEntry2::Interface2>::value, "Invalid assumption");
...
static_assert(std::is_standard_layout<PluginDesc>::value, "Invalid assumption");
